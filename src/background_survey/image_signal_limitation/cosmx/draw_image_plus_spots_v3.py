...
def draw_spots_strong_weak_intensity(
    ...
    for window_idx, window in enumerate(windows):
        ...
        rect = Rectangle((x_rc, y_rc), width, height, linewidth = 12, edgecolor = 'black', facecolor = 'none')
        ax.add_patch(rect)
        # bold font text
    ...
    fig.savefig(f'v3/lungtumor_dapi_spots_min={min_intensities}_mainFigure.png', dpi = 300, bbox_inches = 'tight')
    ...
    for window_idx, window in enumerate(windows):
        ...
        ax.scatter(x_window[signals_window < min_intensities], y_window[signals_window < min_intensities], s = 0.6, c = 'r')
        ax.scatter(x_window[signals_window >= min_intensities], y_window[signals_window >= min_intensities], s = 0.6, c = 'blue')
        ...
        fig.savefig(f'v3/lungtumor_dapi_spots_min={min_intensities}_Window{window_idx + 1}.png', dpi = 300, bbox_inches = 'tight')
