...
def load_results():
    ...
    df_bering = pd.read_csv('/data/aronow/Kang/spatial/Bering/ileum/output/spots_all.txt', sep = '\t', header = 0, index_col = 0)
...
if __name__ == '__main__':
    ...
    fig, axes = plt.subplots(figsize = (30, 15), nrows = 1, ncols = 3, sharex = True, sharey = True, gridspec_kw = {'wspace': 0.05, 'hspace': 0.05})
